...
set OUTDIR=runs\voice_guard_v13_seqcnn
set CACHE=cache
echo %date% %time% Arm B v13 seqcnn_v1 training started on CPU >> runs\v13_armB_seqcnn_train.log
...
echo %date% %time% Arm B training finished with exit code %errorlevel% >> runs\v13_armB_seqcnn_train.log
@echo off
cd /d C:\Users\Tuviksh Murudkar\SIH\voice_guard\model_training
